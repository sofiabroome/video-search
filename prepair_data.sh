...
for i in $( ls videos ); do
	...
	thingscoop describe $file -m googlenet_imagenet
	# fi
done

python data_extraction/combine_json_data.py data_extraction/meta.txt videos data_all_exapnded_stop.json 2 googlenet_imagenet
